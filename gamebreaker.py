...
class Ball(GameObject):
    def __init__(self, canvas, x, y, speed):
        super().__init__(canvas, x, y, 10, 10, 'red')
        self.speed = speed
        self.dx = speed
        self.dy = -speed
...
class Paddle(GameObject):
    def __init__(self, canvas, width):
        ...
        super().__init__(canvas, self.canvas_width/2 - width/2, 350, width, 10, 'blue')
        self.speed = 6
        self.canvas = canvas
...
class Brick(GameObject):
    def __init__(self, canvas, x, y, hits_to_break, color):
        super().__init__(canvas, x, y, 50, 20, color)
